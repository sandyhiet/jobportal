              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  <tr>
                    ...
                    <td style="text-transform: capatalize;">{{$all_keyskills[$key]->Keyskill_name}}</td>
                    
                    <td>
                      <a href="{{url('admin/update_skill/'.$all_keyskills[$key]->id)}}">Edit</a> | 
                      <a onclick="return confirm('Delete this Skill?')" 
                      href="{{url('deletekeyskill/'.$all_keyskills[$key]->id)}}">Delete</a>
                    </td>
