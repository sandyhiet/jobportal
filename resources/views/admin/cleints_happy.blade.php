          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <div class="box box-widget">
                ...
                <div class='box-body'>
                  <img class="img-responsive pad" src="{{url('gallery/filterGallery/thumb322x270/'.$filter_gallery[$key]->image)}}" alt="">
                 
                  
                </div>
                <div class="box-footer">
                  <a href="#" class='btn btn-info btn-xs'><i class='fa fa-edit'></i> Edit</a>
                  <a onclick="return confirm('Delete this image?')" href="#" class='btn btn-danger btn-xs'><i class='fa fa-trash'></i> Delete</a>
                </div><!-- /.box-footer -->
              </div><!-- /.box -->
            </div>
            <?php }}?>
