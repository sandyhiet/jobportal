            ...
            <div class="col-md-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">Add Role <!-- <small>you can publish or save as a draft.</small> --></h3>
                </div><!-- /.box-header -->
                <div class="box-body pad">
                  ...
                  <form method="post" action="{{url('add_role_category')}}" autocomplete="off">
                    ...
                    <div class="form-group">
                      ...
                      <input name="role_category_name" type="text" value="{{ old('role_category_name') }}" class="form-control" id="" placeholder="Enter Role Category Name" maxlength="50">
