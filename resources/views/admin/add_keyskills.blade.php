                ...
                <div class="box-body pad">
                  ...
                  <form method="post" action="{{url('admin/add_keyskills')}}" autocomplete="off">
                    ...
                    <div class="form-group">
                      <label for="">Keyskills Name</label>
                      <input name="Keyskill_name" type="text" value="{{ old('Keyskill_name') }}" class="form-control" id="" placeholder="Enter Keyskills Name" maxlength="50">
