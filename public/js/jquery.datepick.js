...
$.extend(Datepicker.prototype, {
	...
	_generateMonthSelection: function(inst, year, month, minDate, maxDate, monthHeader) {
		...
		var selector = '<select style="border:0px solid #ffffff;height:18px" class="' + this._monthYearClass +
		...
		if (yearRange == 'any') {
			...
			selector = '<select  style="border:0px solid #ffffff;height:18px" class="' + this._monthYearClass +
				'" title="' + inst.get('yearStatus') + '">';
