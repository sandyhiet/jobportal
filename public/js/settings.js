(function($) {
	...
	$(document).ready(function() {
		...
		//--------
		$(".link-recruiter-login").click(function () {
			$("#jr_login").fadeIn(300);
			$("body").addClass("no-scroll");
		});

			$("#jr_login .close").click(function () {
				$("#jr_login").fadeOut(300);
				$("body").removeClass("no-scroll");
			});

		$(".link-recruiter-register").click(function () {
			$("#jr_register").fadeIn(300);
			$("body").addClass("no-scroll");
		});

		$("#jr_register .close").click(function () {
			$("#jr_register").fadeOut(300);
			$("body").removeClass("no-scroll");
		});
